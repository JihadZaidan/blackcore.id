          ...
          <div class="row gx-5">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control bg-disabled" disabled value="{{ $product->name }}">
              </div>
              <div class="form-group">
                <label for="slug">Slug</label>
                <input type="text" class="form-control bg-disabled" disabled value="{{ $product->slug }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control bg-disabled" value="{{ $product->stock }}" disabled>
              </div>
              <div class="form-group">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <div class="mt-2 d-flex flex-column justify-content-center align-items-center">
                  @if ($product->photo)
                    <img src="{{ asset('storage/' . $product->photo) }}" class="w-100 h-auto rounded border"
                      alt="Product Image Preview" style="object-fit:cover">
                  @else
